...
func PerformRequestWithParams(t *testing.T, s *server.Server, method string, path string, body GenericPayload, headers http.Header, queryParams map[string]string) *httptest.ResponseRecorder {
	t.Helper()
...
func PerformRequestWithArrayAndParams(t *testing.T, s *server.Server, method string, path string, body GenericArrayPayload, headers http.Header, queryParams map[string]string) *httptest.ResponseRecorder {
	t.Helper()
...
func PerformRequestWithRawBody(t *testing.T, s *server.Server, method string, path string, body io.Reader, headers http.Header, queryParams map[string]string) *httptest.ResponseRecorder {
	t.Helper()
...
func PerformRequest(t *testing.T, s *server.Server, method string, path string, body GenericPayload, headers http.Header) *httptest.ResponseRecorder {
	t.Helper()

	return PerformRequestWithParams(t, s, method, path, body, headers, nil)
}

func PerformRequestWithArray(t *testing.T, s *server.Server, method string, path string, body GenericArrayPayload, headers http.Header) *httptest.ResponseRecorder {
	t.Helper()
